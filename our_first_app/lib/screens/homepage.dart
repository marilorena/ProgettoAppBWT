...
class _HomePageState extends State<HomePage> {
              ...
              children: [
                GestureDetector(
                  ...
                  GestureDetector(
                      ...
                      onTap: () async { final sleep = await _fetchSleep();
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text('You slept for ${sleep[0].dateOfSleep}')
                                    ],
                                  ),
                                ),
                              );
  ...
  Future<List<FitbitHeartData>> _fetchRate() async {
    return await fitbitHeartDataManager.fetch(FitbitHeartAPIURL.dayWithUserID(
      date: DateTime.now().subtract(Duration(days: 0)
      ),
      userID: '7ML2XV',
  ...
  Future<List<FitbitSleepData>> _fetchSleep() async {
    return await fitbitSleepDataManager.fetch(FitbitSleepAPIURL.withUserIDAndDay(date: DateTime.now().subtract(Duration(days: 1)
    ),
    userID: '7ML2XV',
